...
write.csv(lm_coeff, file.path(stat_path, "ARall_S3_scan_coeff.csv"))
```
...
write.csv(emm, file=file.path(stat_path, "ARall_S3_scan_position_emmeans.csv"), row.names=FALSE)
```
...
s
write.csv(s, file=file.path(stat_path, "ARall_S3_scan_position_contrast.csv"), row.names=FALSE)
```
...
write.csv(emm_2level, file=file.path(stat_path, "ARall_S3_scan_spheroid_emmeans.csv"), row.names=FALSE)
```
...
s
write.csv(s, file=file.path(stat_path, "ARall_S3_scan_spheroid_contrast.csv"), row.names=FALSE)
```
