...
spheroid_position_list = list(
  "last_scan_duration" =              "ARall_last_scan_duration_position_contrast.csv",
...
df_all = bind_rows(spheroid_position_list) %>%
  add_column(
    fig.panel = c(
      "Fig. 8A", "Fig. 9A", "Fig. 9B left", "Fig. 9B right",
...
spheroid_AR_list = list(
  "last_scan_duration" =              "ARall_last_scan_duration_spheroid_contrast.csv",
