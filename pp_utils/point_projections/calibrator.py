...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--name",
        default="hula",
        help="Type name, folder name under -o when -s is issued",
    )
    parser.add_argument(
        "-d",
        "--dimensions",
    ...
    parser.add_argument("-s", "--save", action="store_true", help="Flag to save data")
    parser.add_argument(
        "-o",
        "--outfile",
        default="output/",
    ...
    parser.add_argument(
        "-dlt", "--parse_dlt", action="store_true", help="Parse from saved dlt method"
    )
    parser.add_argument(
        "-pf",
        "--post_fix",
